...
import { AvatarIcon, EmailIcon, LinearRightIcon, UserTagIcon } from '../../../../assets/icons/svg-icons'
...
const AccountDetails = ({ navigation }: any) => {
    ...
    return (
        ...
        >
            <Text className='font-bold text-xl text-dark mt-2xl'>Account Details</Text>
            <View className='flex-col mt-xl'>
                <View className='flex-row justify-between items-center'>
                    ...
                    <View className='flex-row gap-x-4 items-center'>
                        <Text className='text-blue font-medium'>Joseph Stanly</Text>
                        <Pressable 
