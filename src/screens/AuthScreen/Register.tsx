      ...
      verifyOTP(payload)
        ...
        .then((res) => {
          Toast.show({
            ...
            text1: "Verified",
            text2:
              "Phone number verified successfully. Redirecting to final step in 3 seconds",
          });
          setTimeout(() => {
            setRegisterInfo({
              ...registerInfo,
    ...
    >
      <ScrollView>
        ...
        <View className="mt-2xl flex-row items-center">
          ...
          <Text className="text-3xl font-bold text-blue mx-xs">
            {registerInfo.step}
          </Text>
        ...
        <View className="mt-2xl">
          ...
          {registerInfo.step === 1 ? (
            <Text className="text-dark opacity-80">
              We require you to verify your phone and provide your information
              to continue
            </Text>
          ) : (
            <Text className="text-dark opacity-80">
              Join the helpful community and contribute in creating a helpful
              environment.
            </Text>
          )}
        </View>
